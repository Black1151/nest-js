...
export type ValueTypes = {
	...
	title: string | Variable<any, string>,
	topicId: ValueTypes["ID"] | Variable<any, string>
};
...
topicsByYearAndSubject?: [{	input: ValueTypes["TopicByYearSubjectInput"] | Variable<any, string>},ValueTypes["TopicEntity"]],
	...
	title?: string | undefined | null | Variable<any, string>,
	topicId?: ValueTypes["ID"] | undefined | null | Variable<any, string>
};
...
topicsByYearAndSubject?: [{	input: ResolverInputTypes["TopicByYearSubjectInput"]},ResolverInputTypes["TopicEntity"]],
	...
	title?: string | undefined | null,
	topicId?: ResolverInputTypes["ID"] | undefined | null
};
	["UpdatePermissionGroupInput"]: {
	description?: string | undefined | null,
	id: number,
...
["JSONObject"]:any;
	...
	title: string,
	topic?: ModelTypes["TopicEntity"] | undefined | null,
	updatedAt: ModelTypes["DateTime"]
};
	["LoginRequest"]: {
	email: string,
	...
	title?: string | undefined | null,
	topicId?: ModelTypes["ID"] | undefined | null
};
	["UpdatePermissionGroupInput"]: {
	description?: string | undefined | null,
	id: number,
...
["JSONObject"]: "scalar" & { name: "JSONObject" };
	...
	title: string,
	topic?: GraphQLTypes["TopicEntity"] | undefined | null,
	updatedAt: GraphQLTypes["DateTime"]
};
	["LoginRequest"]: {
		email: string,
	...
	title?: string | undefined | null,
	topicId?: GraphQLTypes["ID"] | undefined | null
};
	["UpdatePermissionGroupInput"]: {
		description?: string | undefined | null,
	id: number,
